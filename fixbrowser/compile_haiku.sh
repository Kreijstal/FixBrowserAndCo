#!/bin/sh
set -e
[ "`getarch`" == "x86_gcc2" ] && exec setarch x86 "$0"
gcc -DFIXBUILD_BINCOMPAT -DFIXSCRIPT_NO_JIT -Wall -O3 -g -o fixscript.o -c fixscript.c
gcc -Wall -O3 -o fixembed fixembed.c -lm -lroot -lbe
...
gcc -Wall -O3 -g -o fixgui_haiku.o -c fixgui_haiku.c
...
gcc -Wall -O3 -g -o fixbrowser bigint.c crypto.c browser.c script.c util.c image.c css.c fixscript.o crypto_aes.o monocypher.o fixio.o fiximage.o fixgui.o fixgui_haiku.o fixtask.o -lm -lroot -lbe -lnetwork
gcc -Wall -O3 -g -o fixproxy bigint.c crypto.c proxy.c script.c util.c css.c fixscript.o crypto_aes.o monocypher.o fixio.o fixtask.o -lnetwork
strip fixbrowser
strip fixproxy
